...
/**
 * @file handles creation of an element and pointer to itself, its pads, buffer, and bus (if pipeline)
 */
namespace ds3d {
namespace gst {
...
public:
    ElePtr(GstElement* ele, bool takeOwner = true): GstObjPtr<GstElement>(
